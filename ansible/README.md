...
│  Phase 5: Keycloak/Authelia + Mattermost + Nextcloud + OnlyOffice + ...  │
...
| 5 | `services`, `keycloak`, `authelia`, `mattermost`, `nextcloud`, `seaweedfs`, `redcap`, `ecrin`, `onlyoffice`, `flipt` |
...
| Service | URL |
|---------|-----|
| Keycloak/Authelia (SSO) | `https://login.<domain>` |
...
│   ├── platform/           # Vault, PostgreSQL, Redis, Keycloak, Authelia
